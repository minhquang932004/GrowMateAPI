...
namespace GrowMate.Services.Products
{
    ...
    {
        Task<int> CreateProductAsync(CreateProductRequest request, CancellationToken ct = default);
        ...
        Task<bool> UpdateProductAsync(int id, CreateProductRequest request, CancellationToken ct = default);
